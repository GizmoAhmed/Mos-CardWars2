...
{
    [CreateAssetMenu(fileName = "EarnShards_BoundCreature_BuffNerf_Rune", menuName = "Abilities/Runes/EarnShards_BoundCreature_BuffNerf_Rune")]
    public class EarnShards_BoundCreature_BuffNerf_Rune : PassiveAbilitySO
    {
