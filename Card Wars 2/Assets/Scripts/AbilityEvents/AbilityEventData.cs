...
namespace AbilityEvents
{
    public class AbilityEventData
    {
        ...
        public AbilityEventData(AbilityEventType type, GameObject target = null, int v = 0, Dictionary<string, object> customData = null)
        {
            EventType = type;
            targetCard = target;    // optional, some spells ie don't affect cards
